        ...
        <div class="pagecontent">
            <section class="tile">
                <div class="tile-header dvd dvd-btm">
                    <h1 class="custom-font">Listado de <strong>Categorias - Gastos</strong></h1>
                    <ul class="controls">
                        <li><a class="btn-link" href="#myModal" data-toggle="modal"><i class="fa fa-plus mr-5"></i>
                                Nueva Categoria de Gasto</a></li>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open(site_url('gastos/categorias')) ?>
            <div class="modal-header">
                <h3 class="modal-title custom-font">Nueva Categoria de Gasto</h3>
            </div>
